  ...
  return (
    <footer className="flex max-md:flex-col justify-center items-center md:items-end md:px-20 py-10 gap-10">
      <div className="flex flex-col items-start max-md:items-center w-2/3">
        <Image className="h-24 w-24 object-cover" src={logo} alt="Logo marca da Quarta Jovem e da UMP" />
        <p className="max-md:text-center text-xs">
      ...
      <div className="flex flex-col max-md:justify-center md:justify-end items-start">
        <div className="flex justify-center items-center gap-2">
          <FaInstagram size={20} />
          <p className="text-xs">@quartajovem</p>
        </div>
        <div className="flex justify-center items-center gap-2">
          <MdOutlineEmail size={20} />
          <p className="text-xs">quartajovemump@gmail.com</p>
        </div>
      </div>
    </footer>
  );
